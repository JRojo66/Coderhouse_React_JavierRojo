                ...
                <div className="row">
                    <div className="col text-center">
                        <p className="display-1">📖</p>
                            <div className="alert alert-danger" role="alert">The cart is empty!</div>
                        ...
                        <div className="col text-center">
                            <table className="table">
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="#" onClick={clear} className="btn btn-warning">Empty cart<img src={trash} alt="Delete product" width={30} title="Delete product"/></a>
                                        </td>       
                                    </tr>
                                    <tr>
                                        <td></td>
                                    ...
                                    {cart.map(product => 
                                        <tr key={product.id}>
                                            ...
                                            <td><a href="#" onClick={() => {removeItem(product.id)}}><img src={trash} alt="Delete product" width={30} title="Delete product"/>
                                            </a></td>
                                        </tr>
                                    )}
                                    <tr>
                                        <td colSpan={4} className="text-middle"><b>Total</b></td>
